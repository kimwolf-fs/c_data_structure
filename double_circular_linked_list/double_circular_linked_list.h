...
struct double_circular_linked_list{
    struct double_circular_linked_list_node *This;
    ...
    struct double_circular_linked_list_node *(*getNode)(struct double_circular_linked_list *This, int index);
    struct double_circular_linked_list_node *(*getPriorNode)(double_circular_linked_list_node *n);
    struct double_circular_linked_list_node *(*getNextNode)(double_circular_linked_list_node *n);
